...
namespace PrimitivesPro.Editor.MeshEditor
{
    ...
    public class MeshEditor : UnityEditor.Editor
    {
        ...
        void UpdateVertexEditing()
        {
            ...
            if (guiEvent == EventType.MouseUp && !handleSelected && !multiselecting && !painting && vertex == -1)
            {
        ...
        private void UpdatePolygonEditing()
        {
            ...
            if (guiEvent == EventType.MouseUp && !handleSelected && !multiselecting && !painting && face == null)
            {
                Selection.activeObject = null;
            }
        }
        ...
        void UpdateEdgesEditing()
        {
            ...
            if (guiEvent == EventType.MouseUp && !handleSelected && !multiselecting && !painting && edge == null)
            {
